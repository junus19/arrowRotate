...
namespace ExtendedPrimitives_11.Internal {
    ...
    public class FilletPrismEditor : EditorBase {
        ...
        void OnSceneGUI() {
            ...
            var fmh_23_56_639201723662218970 = Quaternion.identity; Vector3 np = Handles.FreeMoveHandle(t.Awp, HandleUtility.GetHandleSize(t.Awp) * 0.05f, Vector3.zero, Handles.CircleHandleCap);
            ...
            var fmh_30_48_639201723662228940 = Quaternion.identity; np = Handles.FreeMoveHandle(t.Bwp, HandleUtility.GetHandleSize(t.Bwp) * 0.05f, Vector3.zero, Handles.CircleHandleCap);
            ...
            var fmh_37_48_639201723662231820 = Quaternion.identity; np = Handles.FreeMoveHandle(t.Cwp, HandleUtility.GetHandleSize(t.Cwp) * 0.05f, Vector3.zero, Handles.CircleHandleCap);
            r = HandleUtility.GUIPointToWorldRay(HandleUtility.WorldToGUIPoint(np));
